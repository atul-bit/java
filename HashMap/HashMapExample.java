//in normal hashMap ordered is not maintanined.
// Two ways to maintain the order
//   1 . LinkedHashMap -> to maintain the insertion order
//   2. TreeMap -> stores the data in a sorted way
...
public class HashMapExample {
    public static void main(String[] args) {
        ...
        System.out.println("Contains atul ?" + marks.containsKey("sushil"));
